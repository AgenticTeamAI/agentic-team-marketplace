...
- 🛡️ **Quality Control** — Controleert agentwerk op feiten, logica, toon, bewijs en procesintegriteit en markeert wat een menselijke blik nodig heeft. Gebruik vóór belangrijke besluiten of publicatie. (activatie: "Review de output van [agent]")
...
- ✍️ **Content Strateeg** — Ontwikkelt samen met jou inhoudelijke, onderbouwde content: van gekozen idee en onderzoek tot concept, review, planning en leren na publicatie. (activatie: "Maak contentplan voor deze maand")
- 🎙️ **De Stem** — Scherpt het onderscheidende verhaal, de geloofwaardige hoek en het passende podium. Gebruik voor thought leadership, PR, media-pitches en personal branding. (activatie: "Schrijf thought leadership over [onderwerp]")
