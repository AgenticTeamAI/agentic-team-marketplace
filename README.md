...
2. Installeer de plugin die bij je licentie hoort: **agentic-team-essentials** (6 agents) of **agentic-team-complete** (18 agents)
3. Bij activering vraagt Claude één keer om je **licentiesleutel** (`atk_...` — uit je welkomstmail). Die wordt veilig lokaal opgeslagen.
